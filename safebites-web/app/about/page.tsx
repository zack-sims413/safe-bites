      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto">
                Stop keyword-searching through thousands of reviews. WiseBites consolidates the data you need to make informed dining decisions.
            </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                ...
                <p className="text-sm text-slate-600">We analyze reviews for critical details like dedicated fryers, cross-contamination practices, and staff knowledge — based on what diners report.</p>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                ...
                <p className="text-sm text-slate-600">We turn thousands of messy reviews into a single, digestible WiseBites Score so you can assess patterns quickly.</p>
            </div>
        </div>
        ...
        <div className="prose prose-slate max-w-none space-y-12">
            <section>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                    I realized that existing platforms were fragmented. Some had great reviews but no safety info; others had safety info but were outdated or had limited reviews. There was no single place to reliably compare information.
                </p>
                <p className="text-slate-600 leading-relaxed">
                    Working in Machine Learning & AI, I decided to build a solution for us. I wanted a tool that could read all those reviews <em>for me</em> and highlight what other gluten-free diners were actually experiencing. As I built it, I realized this wouldn't just help my wife—it could help the entire Celiac and gluten-sensitive community reclaim their time and their freedom to travel.
                </p>
            </section>
