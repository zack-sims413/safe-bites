      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                ...
                <p className="text-sm text-slate-600">Created by a husband for his wife, to bring spontaneity back to dining out after a severe diagnosis.</p>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <Search className="w-8 h-8 text-amber-500 mb-4" />
                <h3 className="font-bold text-slate-900 mb-2">AI Powered</h3>
                <p className="text-sm text-slate-600">We turn thousands of messy reviews into a single, digestible "Safety Score" so you can decide instantly.</p>
            </div>
        </div>
        ...
        <div className="prose prose-slate max-w-none space-y-12">
            ...
            <section>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                    WiseBites combines data from sources like Google Reviews with the specialized, community-verified reviews found only on our platform.
                </p>
                <p className="text-slate-600 leading-relaxed">
